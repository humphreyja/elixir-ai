...
require.register('vue-resource', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'vue-resource/')); }), {});
    /*!
 * vue-resource v0.9.3
...
require.register('vue', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'vue/')); }), {});
    /*!
 * Vue.js v1.0.26
 * (c) 2016 Evan You
 * Released under the MIT License.
...
require.register('vuex', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'vuex/')); }), {});
    /*!
 * Vuex v1.0.0-rc.2
 * (c) 2016 Evan You
 * Released under the MIT License.
...
_vue2.default.use(_vueResource2.default); // Brunch automatically concatenates all files in your
...
new _vue2.default({
  ...
  vuex: {
    actions: {
      submitBrainComponent: function submitBrainComponent(store) {
        store.dispatch("SUBMIT_BRAIN_COMPONENT", this.newBrainComp, this, store);
      },
      showBrainComponent: function showBrainComponent(store, comp) {
        store.dispatch("SHOW_BRAIN_COMPONENT", comp);
      },
      newBrainComponent: function newBrainComponent(store) {
        store.dispatch("NEW_BRAIN_COMPONENT");
      },
      indexBrainComponent: function indexBrainComponent(store) {
        store.dispatch("INDEX_BRAIN_COMPONENT", this);
      },
      editBrainComponent: function editBrainComponent(store, comp) {
    ...
    getters: {
      brain_components: function brain_components(state) {
        return state.brain_components;
      },
      current_brain_component: function current_brain_component(state) {
        return state.current_brain_component;
      },
...
;require.register("web/static/js/vuex/store", function(exports, require, module) {
"use strict";
...
var mutations = {
  LOAD_BRAIN_COMPONENTS: function LOAD_BRAIN_COMPONENTS(state, data) {
    state.brain_components = data;
  },
  SHOW_BRAIN_COMPONENT: function SHOW_BRAIN_COMPONENT(state, data) {
    state.current_brain_component = data;
    state.action = 1; //show
    state.errors = null;
  },
  NEW_BRAIN_COMPONENT: function NEW_BRAIN_COMPONENT(state) {
    state.current_brain_component = {};
    state.action = 2; //new
    state.errors = null;
  },
  EDIT_BRAIN_COMPONENT: function EDIT_BRAIN_COMPONENT(state, data) {
    state.current_brain_component = data;
    state.action = 3; //edit
    state.errors = null;
  },
  INDEX_BRAIN_COMPONENT: function INDEX_BRAIN_COMPONENT(state, v) {
    v.$http.get('/api/components').then(function (response) {
  ...
  SUBMIT_BRAIN_COMPONENT: function SUBMIT_BRAIN_COMPONENT(state, data, v, store) {
    state.current_brain_component = data;
    if (state.current_brain_component == null) {
      return;
    }

    if (state.action == 2) {
      v.$http.post('/api/components', { component: state.current_brain_component }).then(function (response) {
      ...
      v.$http.put('/api/components/' + state.current_brain_component.id, { component: state.current_brain_component }).then(function (response) {
        store.dispatch("INDEX_BRAIN_COMPONENT", v);
        state.errors = null;
      }, function (response) {
        state.errors = JSON.parse(response.body).errors;
